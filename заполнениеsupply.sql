...
SELECT @i=0 FROM dbo.orders WITH (TABLOCKX) WHERE 1=0
    ...
    SET @i=1
		...
		INSERT INTO dbo.supply(Supplier,idMaterials,QuantityMaterials,Price,Delivery_date) 
		select  @SupplierName,CAST( (1+RAND()*(@NumberProducts-1)) as int),(1+RAND()*500),(1+RAND()*500),@odate
